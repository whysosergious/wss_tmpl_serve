 ...
 * Original file: /npm/@lezer/common@1.3.0/dist/index.js
 *
...
((n.closedBy = new n({ deserialize: (e) => e.split(" ") })),
  (n.openedBy = new n({ deserialize: (e) => e.split(" ") })),
  (n.group = new n({ deserialize: (e) => e.split(" ") })),
  (n.isolate = new n({
    deserialize: (e) => {
...
class a {
  ...
  cursorAt(e, t = 0, r = 0) {
    let n = l.get(this) || this.topNode,
      i = new k(n);
    return (i.moveTo(e, t), l.set(this, i._tree), i);
  }
  get topNode() {
    return new x(this, 0, 0, null);
  }
  resolve(e, t = 0) {
    let r = g(l.get(this) || this.topNode, e, t, !1);
    return (l.set(this, r), r);
  }
  resolveInner(e, t = 0) {
    let r = g(f.get(this) || this.topNode, e, t, !0);
  ...
  resolveStack(e, t = 0) {
    return (function (e, t, r) {
      let n = e.resolveInner(t, r),
        s = null;
      for (let e = n instanceof x ? n : n.context.parent; e; e = e.parent)
        if (e.index < 0) {
          let i = e.parent;
          ((s || (s = [n])).push(i.resolve(t, r)), (e = i));
        } else {
          let o = i.get(e.tree);
          if (
            o &&
            ...
            let i = new x(o.tree, o.overlay[0].from + e.from, -1, e);
            (s || (s = [n])).push(g(i, t, r, !1));
          }
        }
      return s ? _(s) : n;
    })(this, e, t);
  ...
  iterate(e) {
    let { enter: t, leave: r, from: n = 0, to: i = this.length } = e,
      s = e.mode || 0,
      o = (s & u.IncludeAnonymous) > 0;
    for (let e = this.cursor(s | u.IncludeAnonymous); ; ) {
      let s = !1;
      if (
        e.from <= i &&
        e.to >= n &&
  ...
  balance(e = {}) {
    return this.children.length <= 8
      ...
      : N(
          ...
          0,
          this.length,
          (e, t, r) => new a(this.type, e, t, r, this.propValues),
          e.makeTree || ((e, t, r) => new a(o.none, e, t, r)),
        );
  }
  static build(t) {
    return (function (t) {
      ...
      let {
        ...
        f = Array.isArray(i) ? new p(i, i.length) : i,
        u = s.types,
        c = 0,
        g = 0;
      function m(e, t, r, n, i, a) {
        let { id: p, start: A, end: k, size: C } = f,
          S = g,
          I = c;
        if (C < 0) {
          if ((f.next(), -1 == C)) {
        ...
        let B,
          ...
          M = u[p],
          T = A - e;
        if (k - A <= o && (z = v(f.pos - t, i))) {
          let t = new Uint16Array(z.size - z.skip),
            r = f.pos - z.size,
            n = t.length;
          for (; f.pos > r; ) n = _(z.start, t, n);
          ((B = new d(t, k - z.start, s)), (T = z.start - e));
        } else {
          let e = f.pos - C;
          f.next();
          let t = [],
          ...
          for (; f.pos > e; )
            n >= 0 && f.id == n && f.size >= 0
              ...
              : a > 2500
                ...
                : m(A, e, t, r, n, a + 1);
          if (
            (n >= 0 && i > 0 && i < t.length && y(t, r, A, i, A, s, n, S, I),
            t.reverse(),
            r.reverse(),
            n > -1 && i > 0)
          ) {
            let e = b(M, I);
            B = N(M, t, r, 0, t.length, 0, k - A, e, e);
          } else B = w(M, t, r, k - A, S - k, I);
        }
        (r.push(B), n.push(T));
      }
      function x(e, t, r, n) {
        ...
        for (; f.pos > t; ) {
          ...
          if (n > 4) f.next();
            ...
            if (l > -1 && t < l) break;
            (l < 0 && (l = r - o), i.push(e, t, r), h++, f.next());
          }
        }
        if (h) {
          let t = new Uint16Array(4 * h),
            o = i[i.length - 2];
          for (let e = i.length - 3, r = 0; e >= 0; e -= 3)
            ((t[r++] = i[e]),
              (t[r++] = i[e + 1] - o),
              (t[r++] = i[e + 2] - o),
              (t[r++] = r));
          (r.push(new d(t, i[2] - o, s)), n.push(o - e));
        }
      }
      function b(e, t) {
        return (r, i, s) => {
          let o,
            ...
            l = 0,
            f = r.length - 1;
          if (f >= 0 && (o = r[f]) instanceof a) {
            if (!f && o.type == e && o.length == s) return o;
            (h = o.prop(n.lookAhead)) && (l = i[f] + o.length + h);
          }
          return w(e, r, i, s, l, t);
        };
      }
      function y(e, t, r, n, i, o, h, l, f) {
        let u = [],
          a = [];
        for (; e.length > n; ) (u.push(e.pop()), a.push(t.pop() + r - i));
        (e.push(w(s.types[h], u, a, o - i, l - o, f)), t.push(i - r));
      }
      function w(e, t, r, i, s, o, h) {
        if (o) {
      ...
      function v(e, t) {
        ...
        return (
          (t < 0 || n == e) && ((u.size = n), (u.start = i), (u.skip = s)),
          u.size > 4 ? u : void 0
        );
      }
      function _(e, t, r) {
        ...
        if ((f.next(), o >= 0 && n < l)) {
          ...
          if (o > 4) {
            let n = f.pos - (o - 4);
            for (; f.pos > n; ) r = _(e, t, r);
          }
          ((t[--r] = h), (t[--r] = s - e), (t[--r] = i - e), (t[--r] = n));
        } else -3 == o ? (c = n) : -4 == o && (g = n);
        return r;
      }
      let A = [],
        k = [];
      ...
      let C =
        null !== (r = t.length) && void 0 !== r
          ? r
          : A.length
            ? k[0] + A[0].length
            : 0;
      return new a(u[t.topID], A.reverse(), k.reverse(), C);
    })(t);
  }
}
a.empty = new a(o.none, [], [], 0);
class p {
  constructor(e, t) {
...
class d {
  ...
  childString(e) {
    let t = this.buffer[e],
      ...
      n = this.set.types[t],
      i = n.name;
    if ((/\W/.test(i) && !n.isError && (i = JSON.stringify(i)), r == (e += 4)))
      return i;
    let s = [];
...
function g(e, t, r, n) {
  for (
    ...
    let t = !n && e instanceof x && e.index < 0 ? null : e.parent;
    if (!t) return e;
    e = t;
  }
  ...
  if (n)
    for (let n = e, o = n.parent; o; n = o, o = n.parent)
      n instanceof x &&
        n.index < 0 &&
        (null === (i = o.enter(t, r, s)) || void 0 === i ? void 0 : i.from) !=
          n.from &&
        (e = o);
  for (;;) {
    let n = e.enter(t, r, s);
...
class x extends m {
  ...
  nextChild(e, t, r, n, s = 0) {
    for (let o = this; ; ) {
      for (
        let { children: h, positions: l } = o._tree, f = t > 0 ? h.length : -1;
        e != f;
        e += t
      ) {
        let f = h[e],
          a = l[e] + o.from;
        if (c(n, r, a, a + f.length))
          if (f instanceof d) {
            if (s & u.ExcludeBuffers) continue;
            let i = f.findChild(0, f.buffer.length, t, r - a, n);
            if (i > -1) return new v(new w(o, f, e, a), null, i);
          } else if (s & u.IncludeAnonymous || !f.type.isAnonymous || C(f)) {
            let h;
            if (!(s & u.IgnoreMounts) && (h = i.get(f)) && !h.overlay)
              return new x(h.tree, a, e, o);
            let l = new x(f, a, e, o);
            return s & u.IncludeAnonymous || !l.type.isAnonymous
              ? l
              : l.nextChild(t < 0 ? f.children.length - 1 : 0, t, r, n);
          }
      }
      if (s & u.IncludeAnonymous || !o.type.isAnonymous) return null;
      if (
        ((e =
          o.index >= 0
            ? o.index + t
  ...
  enter(e, t, r = 0) {
    let n;
    if (!(r & u.IgnoreOverlays) && (n = i.get(this._tree)) && n.overlay) {
      let r = e - this.from;
      for (let { from: e, to: i } of n.overlay)
        if ((t > 0 ? e <= r : e < r) && (t < 0 ? i >= r : i > r))
          return new x(n.tree, n.overlay[0].from + this.from, -1, this);
    }
...
class v extends m {
  ...
  get nextSibling() {
    ...
    return t <
      ...
      ? new v(this.context, this._parent, t)
  ...
  get prevSibling() {
    ...
    return this.index == t
      ? this.externalSibling(-1)
      : new v(this.context, this._parent, e.findChild(t, this.index, -1, 0, 4));
  }
  get tree() {
    return null;
  }
  toTree() {
    ...
    return new a(this.type, e, t, this.to - this.from);
  }
  toString() {
...
function _(e) {
  ...
  let n = r instanceof x && r.index < 0 ? null : r.parent,
    i = e.slice();
  return (n ? (i[t] = n) : i.splice(t, 1), new A(i, r));
}
class A {
  constructor(e, t) {
...
class k {
  ...
  enter(e, t, r = this.mode) {
    return this.buffer
      ? !(r & u.ExcludeBuffers) && this.enterChild(1, e, t)
  ...
  get node() {
    ...
    for (let e = r; e < this.stack.length; e++)
      t = new v(this.buffer, t, this.stack[e]);
  ...
  matchContext(e) {
    ...
    for (let n = e.length - 1, i = this.stack.length - 1; n >= 0; i--) {
      if (i < 0) return y(this._tree, e, n);
...
class z {
  ...
  static addTree(e, t = [], r = !1) {
    let n = [new z(0, e.length, e, 0, !1, r)];
        ...
        for (; s && s.from < u; ) {
          ...
          if (h >= t.from || u <= t.to || l) {
            let e = Math.max(t.from, h) - l,
              r = Math.min(t.to, u) - l;
            t = e >= r ? null : new z(e, r, t.tree, t.offset + l, o > 0, !!f);
          }
...
function E(e) {
  return (t, r, n, i) => new D(t, e, r, n, i);
}
class P {
  constructor(e, t, r, n, i) {
    ((this.parser = e),
...
class D {
  ...
  advance() {
      ...
      return (
        null != this.stoppedAt &&
          (e = new a(
            ...
            e.positions,
            e.length,
            e.propValues.concat([[F, this.stoppedAt]]),
          )),
        e
      );
    }
    ...
    if (t) {
      ...
      ((r[n.mounted.id] = new i(t, e.overlay, e.parser)), (e.target.props = r));
    }
    return null;
  }
  get parsedPos() {
  ...
  startInner() {
    ...
    e: for (let s, o; ; ) {
      ...
      if (null != this.stoppedAt && i.from >= this.stoppedAt) l = !1;
        ...
        if (t) {
          ...
          if (e)
            for (let r of e.mount.overlay) {
              ...
              n >= i.from &&
                s <= i.to &&
                !t.ranges.some((e) => e.from < s && e.to > n) &&
                t.ranges.push({ from: n, to: s });
            }
        }
        l = !1;
      } else if (n && (o = R(n.ranges, i.from, i.to))) l = 2 != o;
      else if (
        !i.type.isAnonymous &&
        (s = this.nest(i, this.input)) &&
        (i.from < i.to || !s.overlay)
      ) {
        i.tree || (U(i), t && t.depth++, n && n.depth++);
        let o = e.findMounts(i.from, s.parser);
        if ("function" == typeof s.overlay)
          t = new j(
            s.parser,
            s.overlay,
            o,
          ...
          let e = V(
            this.ranges,
            s.overlay || (i.from < i.to ? [new r(i.from, i.to)] : []),
          );
          (e.length && O(e),
            (!e.length && s.overlay) ||
              this.inner.push(
                new P(
                  s.parser,
                  e.length
                    ? s.parser.startParse(this.input, G(o, e), e)
                    : s.parser.startParse(""),
                  s.overlay
                    ? s.overlay.map(
                        (e) => new r(e.from - i.from, e.to - i.from),
                      )
                    : null,
                  i.tree,
        ...
        t &&
        (h = t.predicate(i)) &&
        (!0 === h && (h = new r(i.from, i.to)), h.from < h.to)
      ) {
        let e = t.ranges.length - 1;
        e >= 0 && t.ranges[e].to == h.from
          ? (t.ranges[e] = { from: t.ranges[e].from, to: h.to })
          : t.ranges.push(h);
      }
          ...
          if (t && !--t.depth) {
            ...
            (e.length &&
              ...
              this.inner.splice(
                ...
                new P(
                  t.parser,
                  t.parser.startParse(this.input, G(t.mounts, e), e),
                  t.ranges.map((e) => new r(e.from - t.start, e.to - t.start)),
                  t.target,
                  e[0].from,
                ),
              )),
...
function U(e) {
  ...
  let i = e.tree,
    ...
    l = h.buffer,
    f = [s];
  i.children[s] = (function e(n, i, s, o, u, p) {
    let d = r[p],
      c = [],
      g = [];
    W(h, n, d, c, g, o);
    ...
    f.push(c.length);
    let b = p
      ? e(d + 4, l[d + 3], h.set.types[l[d]], m, x - m, p - 1)
      : t.toTree();
    return (
      c.push(b),
      g.push(m - o),
  ...
  })(0, l.length, o.none, 0, h.length, r.length - 1);
  for (let t of f) {
    let r = e.tree.children[t],
      n = e.tree.positions[t];
    e.yield(new x(r, n + e.from, t, e._tree));
  }
}
class J {
  constructor(e, t) {
  ...
  moveTo(e) {
    ...
    for (; !this.done && t.from < r; )
      (t.to >= e && t.enter(r, 1, u.IgnoreOverlays | u.ExcludeBuffers)) ||
        t.next(!1) ||
        (this.done = !0);
  }
  hasNode(e) {
...
class L {
  constructor(e) {
    ...
    if (((this.fragments = e), (this.curTo = 0), (this.fragI = 0), e.length)) {
      ...
      ((this.curTo = null !== (t = r.tree.prop(F)) && void 0 !== t ? t : r.to),
        (this.inner = new J(r.tree, -r.offset)));
  ...
  nextFrag() {
    ...
    if ((this.fragI++, this.fragI == this.fragments.length))
      ...
      ((this.curTo = null !== (e = t.tree.prop(F)) && void 0 !== e ? e : t.to),
        (this.inner = new J(t.tree, -t.offset)));
    }
  }
  findMounts(e, t) {
    var r;
  ...
  for (let s = 1, o = 0; s < e.length; s++) {
    ...
    for (; o < i.length; o++) {
      ...
      e.to <= h ||
        ...
        e.from < h
          ? ((n[o] = new r(e.from, h)),
            e.to > l && n.splice(o + 1, 0, new r(l, e.to)))
          : e.to > l
            ? (n[o--] = new r(l, e.to))
            : n.splice(o--, 1));
    }
...
function H(e, t, n, i) {
  let s = 0,
    ...
    u = [];
  for (;;) {
    let a = s == e.length ? 1e9 : h ? e[s].to : e[s].from,
...
function G(e, t) {
  let n = [];
  for (let { pos: i, mount: s, frag: o } of e) {
    let e = i + (s.overlay ? s.overlay[0].from : 0),
      h = e + s.tree.length,
      l = Math.max(o.from, e),
      f = Math.min(o.to, h);
    if (s.overlay) {
      let h = H(
        t,
        s.overlay.map((e) => new r(e.from + i, e.to + i)),
        l,
        f,
      );
      for (let t = 0, r = l; ; t++) {
...
export default null;
//# sourceMappingURL=/sm/96be334e4da0c3fd947f358e2fad7eed421009f87983bbac317482417dd4540b.map
